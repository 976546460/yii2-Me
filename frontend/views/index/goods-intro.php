...
$this->registerJsFile('/js/header.js');
	...
	<div class="goods_content fl mt10 ml10">
		...
		<div class="summary">
			...
			<div class="preview fl">
				<div class="midpic">
					<a href="<?=$goods->logo?>" class="jqzoom" rel="gal1" title="" style="outline-style: none; text-decoration: none;">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<div class="zoomPad"><img src="<?=$goods->logo?>" alt="" title="" style="opacity: 1;" width="350px"><div class="zoomPup" style="top: -1px; left: -1px; width: 175px; height: 175px; position: absolute; border-width: 1px; display: none;"></div><div class="zoomWindow" style="position: absolute; z-index: 5001; left: 360px; top: 0px; display: none;"><div class="zoomWrapper" style="width: 400px;"><div class="zoomWrapperTitle" style="width: 100%; position: absolute; display: none;"></div><div class="zoomWrapperImage" style="width: 100%; height: 400px;"><img src="/images/preview_l1.jpg" style="position: absolute; border: 0px; display: block; left: 0px; top: 0px;"></div></div></div><div class="zoomPreload" style="visibility: hidden; top: 153.5px; left: 130px; position: absolute;">Loading zoom</div></div>               <!-- 第一幅图片的中图 -->
					</a>
				</div>
						...
						<ul>
							...
							<li class="cur">
								<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '/images/preview_m1.jpg',largeimage: '/images/preview_l1.jpg'}">
									<img src="/images/preview_m1.jpg"></a>
							</li>
							<?php endforeach; ?>
						</ul>
					</div>
			...
			<div class="goodsinfo fl ml10">
				...
				<form action="<?=\yii\helpers\Url::to(['index/add'])?>" method="post" class="choose">
					<ul>
